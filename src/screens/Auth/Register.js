...
import {Container, TextInputContainer} from '../../components/common';
import {
  onChangeName,
  onChangePhone,
  onChangeEmail,
        ...
        <ScrollView
          ...
          <View style={logoBlock}>
            ...
            <View style={titleTextContainer}>
              <Text style={titleText}>Регистрация</Text>
            </View>
          </View>
          <View style={formBlock}>
            ...
            <View
              ...
              <Text style={infoText}>Код отправленый вам в смс сообщении</Text>
            </View>
            <TextInputContainer
              display={this.props.code ? 'flex' : 'none'}
              placeholder=""
